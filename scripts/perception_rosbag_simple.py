...
class SimplePerceptionProcessor(Node):
    """真实感知处理器 - 最简版本"""
    
    def __init__(self):
        super().__init__('simple_perception_processor')
...
使用方法：
  ...
  2. 在另一个终端运行此脚本：
     python3 scripts/perception_rosbag_simple.py
  3. 启动RViz：
     bash start_rviz2.sh
...
""")
    ...
    processor = SimplePerceptionProcessor()
